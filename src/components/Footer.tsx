...
const Footer = memo(() => {
  ...
  return (
    <footer className="relative z-10 bg-black border-t border-white/5 pt-12 pb-8">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 pb-12">
          ...
          <div className="col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold bg-gradient-to-r from-white to-gray-400 bg-clip-text text-transparent">PIGEN</span>
            </div>
            <p className="text-gray-400 text-sm mb-6 max-w-xs">
              AI-powered project idea generator for developers and entrepreneurs, tailored to your skills and interests.
            </p>
            <div className="flex space-x-4">
              {['twitter', 'github', 'linkedin', 'instagram'].map((social) => (
                ...
                >
                  ...
                  <div className="w-8 h-8 flex items-center justify-center rounded-full bg-white/5 hover:bg-white/10 transition-colors duration-200 border border-white/10">
        ...
        <div className="border-t border-white/5 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm order-2 md:order-1 mt-4 md:mt-0">
            &copy; {currentYear} PIGEN. All rights reserved.
          </p>
