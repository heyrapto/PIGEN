...
const ChatMessage = ({ content, sender, timestamp, type = 'text' }: ChatMessageProps) => {
  return (
    ...
    >
      {sender === 'system' && (
        <div className="mr-2 h-8 w-8 flex-shrink-0 rounded-full bg-black p-1.5 border border-white/10">
      ...
      {sender === 'user' && (
        <div className="ml-2 h-8 w-8 flex-shrink-0 rounded-full bg-white/10 overflow-hidden">
